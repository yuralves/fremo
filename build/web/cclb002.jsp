...
<%@ page import="data.ClubesDevedoresDO" %>
...
pageContext.forward("./index.jsp");
    ...
    Vector clubes = tn.cobrar_clubes(id, mes, ano);
    for(int i=0; i<clubes.size (); i++){
        ClubesDevedoresDO devedores = (ClubesDevedoresDO)clubes.elementAt(i);
        
        %><br><br>  Clube: <%=devedores.getNome_Do_Clube()%><%
        %><br><br>  Email: <%=devedores.getEmail_Do_Clube()%><%
        %><br><br>  Valor a ser pago: <%=devedores.getMensalidade()%><br><%
                ...
                <form action="./cclb002.jsp" method="post">
                    CCLB 002 <br><br>
                    Ano: 
