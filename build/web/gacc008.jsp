...
<html>
    <form action="./gacc008.jsp" method="post"><!mantem na mesma pagina e gera o request nos botoes)>
        <head>
...
pageContext.forward("./main.jsp");
    ...
    pageContext.forward("./index.jsp");
                    ...
                    int idExcluido = Integer.parseInt(request.getParameter("atleta"));
                    UsuarioDO excluir = tn.busca_usuario_por_ID(idExcluido);
                    AtletaDO atleta = tn.busca_atleta_por_ID_atleta(idExcluido);
                    excluir.setHabilitado_ATLETA(false);
                    boolean bool = tn.atualizar_usuario(excluir);
                    if(bool){%>
                        <td height="400" width:="250" align = "Center">
                        <h3><%= atleta.getNOME_ATLETA() + " " + atleta.getSOBRENOME_ATLETA()%> inativado com sucesso</h3>
        ...
        <td height="400" width:="500" align = "Center" valign="center">
            <h3>Inativar conta de técnico</h3> 
                <select style="width: 250px;" name="atleta" required>
                                ...
                                <%for(int j = 0; j < atletas.size(); j++) { //for loop para cada tecnico
                                    AtletaDO atleta = (AtletaDO)atletas.elementAt(j); //escolhe o j-esimo clube e faz o html
                ...
                <input type="submit" class = "botao3" name="Inativar" value="Inativar atleta">                       
        </td>
        </tr>
    </table>
<%}%>
