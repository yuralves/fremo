...
<html>
    <form action="./gacc011.jsp" method="post"><!mantem na mesma pagina e gera o request nos botoes)>
        <head>
...
pageContext.forward("./index.jsp");
...
else if(null != request.getParameter("Ir")){
    ...
    data.TecnicoDO tecnico = tn.busca_tecnico_por_ID_tecnico(id_user);
    
    tecnico.setNomeTecnico(nome);
    tecnico.setSobrenomeTecnico(sobrenome);
    tecnico.setRgTecnico(rg);
    tecnico.setCpfTecnico(cpf);
    tecnico.setDataNascimentoTecnico(data_nascimento);
    boolean result = false;
    try {
        result = tn.atualizar_Tecnico(tecnico);
    }catch (Exception e) {
%>           <%= e.toString() %>
<%
       }
