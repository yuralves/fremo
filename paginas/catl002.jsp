...
pageContext.forward("./index.jsp");
    ...
    MensalidadeAtletasDO mensalidade = new MensalidadeAtletasDO();
    mensalidade.setAno(ano);
    mensalidade.setId_ATLETA(idatleta);
    mensalidade.setMes(mes);
    transacoes.CATL tn = new transacoes.CATL();
    boolean result = false;
    try {
        result = tn.inserir_mensalidade_atleta(mensalidade);
    } catch(Exception e) {
    }
%><br><br>Opera&ccedil;&atilde;o realizada com sucesso!<%
                ...
                <form action="./catl002.jsp" method="post">
                    CATL 002 <br><br>
